...
public class GoogleHypothesis3 {
	public static void main(String[] args) {
		...
		rsColl.clear();
		RitHMSpecification rSpec1 =  new DefaultRiTHMSpecification("FORALL(XOBJ)[](a(XOBJ)->Xb(XOBJ))");
		rsColl.add(rSpec1);
		...
		try {
			...
			while ((line = br.readLine()) != null) {
				...
				if(csved[5].equals("0"))
					...
					ps.setValue("a", "0");
				if(csved[5].equals("4")||csved[5].equals("1")|| csved[5].equals("3")||
						csved[5].equals("2")||csved[5].equals("5"))
					ps.setValue("b", "1");
				else
					ps.setValue("b", "0");
