...
//    	RitHMSpecification rSpec13 =  new DefaultRiTHMSpecification("[*](a4->(! a3 && (X*a3)))");
    	RitHMSpecification rSpec21 =  new DefaultRiTHMSpecification("[](X a2->(! (X a1) && a1))");
//    	RitHMSpecification rSpec22 =  new DefaultRiTHMSpecification("[](X a3->(! (X a2) && a2))");
//    	RitHMSpecification rSpec23 =  new DefaultRiTHMSpecification("[](X a4->(! (X a3) && a3))");
    	rsColl1.add(rSpec11);
//    	rsColl1.add(rSpec12);
//    	rsColl1.add(rSpec13);
    	rsColl2.add(rSpec21);
