...
//    	
    	...
    	RitHMSpecification rSpec11 =  new DefaultRiTHMSpecification("[*](a1)");
//    	RitHMSpecification rSpec12 =  new DefaultRiTHMSpecification("[*](a1->X*a2)");
//    	RitHMSpecification rSpec13 =  new DefaultRiTHMSpecification("[*](a1->X*a2)");
    	RitHMSpecification rSpec21 =  new DefaultRiTHMSpecification("[](a1)");
//    	RitHMSpecification rSpec22 =  new DefaultRiTHMSpecification("[](Xa2->a3)");
//    	RitHMSpecification rSpec23 =  new DefaultRiTHMSpecification("[](Xa3->a2)");
    	rsColl1.add(rSpec11);
//    	rsColl1.add(rSpec12);
//    	rsColl1.add(rSpec13);
    	rsColl2.add(rSpec21);
