...
public static void main(String[] args) {
	...
	rsColl.clear();
	RitHMSpecification rSpec1 =  new DefaultRiTHMSpecification("FORALL(YOBJ)FORALL(XOBJ)(<>(a(XOBJ) && <>b(XOBJ)))");
	rsColl.add(rSpec1);
	...
	for(int i= 0; i < Integer.parseInt(args[0]);i++){
		...
		for(int j = 0; j < Integer.parseInt(args[3]); j++)
		{
    		...
    		ps.setValue("YOBJ", Integer.toString(rn.nextInt() % 1000));
